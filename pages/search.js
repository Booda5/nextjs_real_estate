...
return(
    <Box>
        ...
        <Text fontSize='2xl' p='4' fontWeight='bold'>proprties {router.query.purpose}</Text>
        <Flex flexWrap='wrap'>
            {properties.map((property) => <Property property={property} key={property.id}/>)}
        </Flex>
        {properties.length === 0 && (
            <Flex justifyContent='center' flexDirection='column' marginTop='5' marginBottom='5' alignItems='center'>
